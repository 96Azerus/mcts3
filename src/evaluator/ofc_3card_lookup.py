# src/evaluator/ofc_3card_lookup.py
# -*- coding: utf-8 -*-
...
# Строка рангов (rank_string) также отсортирована по убыванию для консистентности.

# Таблица остается без изменений, так как она не содержит импортов card.py
three_card_lookup = {
    (0, 0, 0): (13, 'Trips', '222'),
    (1, 0, 0): (169, 'Pair', '322'),
    (1, 1, 0): (157, 'Pair', '332'),
